...
export default {
    ...
    methods: {
        ...
        line(){
            location.replace("https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=1554433367&redirect_uri=https://d33e15c1.ngrok.io&state=12345abcde&scope=openid%20profile%20email")
        },
        loginByLine(){
        ...
        getdata(){
            ...
            code: userUrlCode,
            redirect_uri: 'https://d33e15c1.ngrok.io',
