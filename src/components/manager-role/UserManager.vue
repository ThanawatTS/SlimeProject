<template>
 <v-app style="
  ...
  <br>
    ...
    <p>Manage restaurant queue</p>
    <br>
    <br>
    <br>
    <br>
    
     <a href="#" class="btn-two green rounded" @click="claimTobeOwner">Restuarant</a>
    </div>

    <div id = "right">
    <h2>Customer</h2>
    <p>Find restaurants around your location</p>
    <p>Join queue of your favorite restaurant</p>
    <p>Get notification from line when your queue is near</p>
    <p>Get random menu when you don't know what to eat</p>
          <br>
    <a href="#" class="btn-two green rounded" @click="claimTobeCustomer">Customer</a>
    </div>
